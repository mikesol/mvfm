...
function buildKinds(): Record<string, KindSpec<any, any>> {
  return {
    ...
    "redis/hgetall": { inputs: [""] as [string], output: {} as Record<string, string> } as KindSpec<
      [string],
      Record<string, string>
    >,
    "redis/hdel": { inputs: [""] as [string, ...string[]], output: 0 as number } as KindSpec<
      [string, ...string[]],
      number
    >,
    ...
    // List commands
    "redis/lpush": { inputs: [""] as [string, ...string[]], output: 0 as number } as KindSpec<
      [string, ...string[]],
      number
    >,
    "redis/rpush": { inputs: [""] as [string, ...string[]], output: 0 as number } as KindSpec<
      [string, ...string[]],
      number
    >,
    ...
    // Structural helpers
    "redis/record": { inputs: [] as unknown[], output: {} as Record<string, unknown> } as KindSpec<
      unknown[],
