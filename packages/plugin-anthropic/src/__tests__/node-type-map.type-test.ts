...
const _positive = defineInterpreter<"anthropic/create_message">()({
...
const _badAny = defineInterpreter<"anthropic/create_message">()({
...
const _wrongType = defineInterpreter<"anthropic/create_message">()({
