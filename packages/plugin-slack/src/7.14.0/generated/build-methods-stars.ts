...
export function buildSlackStars(): SlackMethodsStars {
  return {
    add(params) {
      if (params != null) return mk("slack/stars_add", [liftArg(params)]);
      return mk("slack/stars_add", []);
    },
    list(params) {
      if (params != null) return mk("slack/stars_list", [liftArg(params)]);
      return mk("slack/stars_list", []);
    },
    remove(params) {
      if (params != null) return mk("slack/stars_remove", [liftArg(params)]);
