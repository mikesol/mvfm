...
export interface SlackMethodsAdminConversations {
  ekm: {
    listOriginalConnectedChannelInfo<A = void>(
      params?: A,
    ): CExpr<
      AdminConversationsEkmListOriginalConnectedChannelInfoResponse,
  ...
  archive<A>(
    params: A,
  ): CExpr<AdminConversationsArchiveResponse, "slack/admin_conversations_archive", [A]>;
  bulkArchive<A>(
    params: A,
  ): CExpr<AdminConversationsBulkArchiveResponse, "slack/admin_conversations_bulkArchive", [A]>;
  bulkDelete<A>(
    params: A,
  ): CExpr<AdminConversationsBulkDeleteResponse, "slack/admin_conversations_bulkDelete", [A]>;
  bulkMove<A>(
    params: A,
  ): CExpr<AdminConversationsBulkMoveResponse, "slack/admin_conversations_bulkMove", [A]>;
  convertToPrivate<A>(
    params: A,
  ): CExpr<
    AdminConversationsConvertToPrivateResponse,
  ...
  create<A>(
    params: A,
  ): CExpr<AdminConversationsCreateResponse, "slack/admin_conversations_create", [A]>;
  delete<A>(
    params: A,
  ): CExpr<AdminConversationsDeleteResponse, "slack/admin_conversations_delete", [A]>;
  disconnectShared<A>(
    params: A,
  ): CExpr<
    AdminConversationsDisconnectSharedResponse,
  ...
  getTeams<A>(
    params: A,
  ): CExpr<AdminConversationsGetTeamsResponse, "slack/admin_conversations_getTeams", [A]>;
  invite<A>(
    params: A,
  ): CExpr<AdminConversationsInviteResponse, "slack/admin_conversations_invite", [A]>;
  lookup<A>(
    params: A,
  ): CExpr<AdminConversationsLookupResponse, "slack/admin_conversations_lookup", [A]>;
  removeCustomRetention<A>(
    params: A,
  ): CExpr<
    AdminConversationsRemoveCustomRetentionResponse,
  ...
  rename<A>(
    params: A,
  ): CExpr<AdminConversationsRenameResponse, "slack/admin_conversations_rename", [A]>;
  search<A = void>(
    params?: A,
  ): CExpr<AdminConversationsSearchResponse, "slack/admin_conversations_search", [A]>;
  setConversationPrefs<A>(
    params: A,
  ): CExpr<
    AdminConversationsSetConversationPrefsResponse,
  ...
  setTeams<A>(
    params: A,
  ): CExpr<AdminConversationsSetTeamsResponse, "slack/admin_conversations_setTeams", [A]>;
  unarchive<A>(
    params: A,
  ): CExpr<AdminConversationsUnarchiveResponse, "slack/admin_conversations_unarchive", [A]>;
}
