...
export interface SlackMethodsApps {
  connections: {
    open<A = void>(
      params?: A,
    ): CExpr<AppsConnectionsOpenResponse, "slack/apps_connections_open", [A]>;
  };
  event: {
    authorizations: {
      list<A>(
        params: A,
      ): CExpr<AppsEventAuthorizationsListResponse, "slack/apps_event_authorizations_list", [A]>;
    };
  };
  manifest: {
    ...
    validate<A>(
      params: A,
    ): CExpr<AppsManifestValidateResponse, "slack/apps_manifest_validate", [A]>;
  };
