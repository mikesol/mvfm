...
export function buildSlackPins(): SlackMethodsPins {
  return {
    add(params) {
      if (params != null) return mk("slack/pins_add", [liftArg(params)]);
      return mk("slack/pins_add", []);
    },
    list(params) {
      if (params != null) return mk("slack/pins_list", [liftArg(params)]);
      return mk("slack/pins_list", []);
    },
    remove(params) {
      if (params != null) return mk("slack/pins_remove", [liftArg(params)]);
