...
export function buildSlackSearch(): SlackMethodsSearch {
  return {
    all(params) {
      if (params != null) return mk("slack/search_all", [liftArg(params)]);
      return mk("slack/search_all", []);
    },
    files(params) {
      if (params != null) return mk("slack/search_files", [liftArg(params)]);
      return mk("slack/search_files", []);
    },
    messages(params) {
      if (params != null) return mk("slack/search_messages", [liftArg(params)]);
