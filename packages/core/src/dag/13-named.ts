...
import type { LiveAdj } from "./08-gc";
import { liveAdj } from "./08-gc";
import type {
  DirtyExpr,
  DirtyAdjOf,
} from "./09-dirty";
import { dirty } from "./09-dirty";
import { gc, commit } from "./10-commit";
import { numLit, add, mul } from "./02-build";
import { app } from "./03-normalize";
import { byName } from "./04-predicates";
import { selectWhere } from "./05-select";
import { replaceWhere } from "./07-replace";
